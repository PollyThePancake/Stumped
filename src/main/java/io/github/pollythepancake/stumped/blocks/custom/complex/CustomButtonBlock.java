...
public class CustomButtonBlock extends CustomBlock {

    public static ArrayList<Item> items = new ArrayList<>();
    public static ArrayList<Block> blocks = new ArrayList<>();

    public CustomButtonBlock(String id, boolean isFuel) {
        super(id, new WoodenButtonBlock(FabricBlockSettings.copyOf(Blocks.OAK_BUTTON)), new FabricItemSettings().group(StumpedGroups.STUMPED_ITEMS));
